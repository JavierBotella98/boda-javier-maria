    ...
    <div>
      <PageHeader
        ...
        subtitle={
          accommodation.isPublished
            ? "Algunas opciones de hoteles cerca de la Hacienda y de la iglesia"
            : undefined
        }
      />
      <div className="mx-auto max-w-3xl px-4 pb-16 sm:px-6">
        {accommodation.isPublished ? (
          ...
          <FadeIn className="mx-auto max-w-xl rounded-lg border border-cream-dark p-8 text-center">
            <p className="text-ink-soft">{accommodation.comingSoonMessage}</p>
          </FadeIn>
        )}
      </div>
    </div>
